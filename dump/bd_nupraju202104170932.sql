...
--
-- Create schema bd_nupraju
--

CREATE DATABASE IF NOT EXISTS bd_nupraju;
USE bd_nupraju;
...
CREATE TABLE `alunos` (
  `alu_matricula` bigint(20) NOT NULL,
  `alu_nome` varchar(100) DEFAULT NULL,
  `alu_email` varchar(100) DEFAULT NULL,
  `alu_telfixo` varchar(14) DEFAULT NULL,
  `alu_telcelular` varchar(14) DEFAULT NULL,
  `alu_endereco` varchar(100) DEFAULT NULL,
  `alu_bairro` varchar(60) DEFAULT NULL,
  `estado_codigo` char(2) DEFAULT NULL,
  `cidade_codigo` char(7) DEFAULT NULL,
  `alu_observacao` mediumtext,
  `alu_datanascimento` date DEFAULT NULL,
  `alu_localnascimento` varchar(100) DEFAULT NULL,
  `alu_ativo` char(3) DEFAULT 'sim',
  `alu_datacadastro` date DEFAULT NULL,
  `alu_dataalterado` date DEFAULT NULL,
  PRIMARY KEY (`alu_matricula`),
  KEY `FK_alunos` (`cidade_codigo`)
...
INSERT INTO `alunos` (`alu_matricula`,`alu_nome`,`alu_email`,`alu_telfixo`,`alu_telcelular`,`alu_endereco`,`alu_bairro`,`estado_codigo`,`cidade_codigo`,`alu_observacao`,`alu_datanascimento`,`alu_localnascimento`,`alu_ativo`,`alu_datacadastro`,`alu_dataalterado`) VALUES 
 (901347414,'Wanderson Santos Academico','wanderson_contabilista@hotmail.com',NULL,NULL,NULL,NULL,'51','5107602',NULL,NULL,NULL,'sim','2021-04-17','2021-04-17');
...
INSERT INTO `cidade` (`cid_codigo`,`cid_nome`,`est_codigo`) VALUES 
...
CREATE TABLE `clientes` (
  `cli_codigo` int(10) NOT NULL DEFAULT '0',
  `cli_razao` varchar(100) DEFAULT NULL,
  `cli_fantasia` varchar(100) DEFAULT NULL,
  `cli_cep` varchar(10) DEFAULT NULL,
  `est_codigo` char(2) DEFAULT NULL,
  `cid_codigo` char(7) DEFAULT NULL,
  `cli_bairro` varchar(60) DEFAULT NULL,
  `cli_logradouro` varchar(100) DEFAULT NULL,
  `cli_enderecoreferencia` varchar(100) DEFAULT NULL,
  `cli_numero` varchar(10) DEFAULT NULL,
  `cli_fisicajuridica` char(3) DEFAULT 'fis',
  `cli_cpfcnpj` varchar(20) DEFAULT NULL,
  `cli_rgie` varchar(15) DEFAULT NULL,
  `cli_telfixo` varchar(14) DEFAULT NULL,
  `cli_telfax` varchar(14) DEFAULT NULL,
  `cli_telcelular` varchar(14) DEFAULT NULL,
  `cli_contato` varchar(30) DEFAULT NULL,
  `cli_email` varchar(60) DEFAULT NULL,
  `cli_ativo` char(3) DEFAULT 'sim',
  `cli_datacadastro` date DEFAULT NULL,
  `cli_dataalterado` date DEFAULT NULL,
  `cli_nomepai` varchar(60) DEFAULT NULL,
  `cli_nomemae` varchar(60) DEFAULT NULL,
  `cli_naturalidade` varchar(60) DEFAULT NULL,
  `cli_sexo` char(3) DEFAULT NULL,
  `cli_estadocivil` char(3) DEFAULT NULL,
  `cli_datanascimento` date DEFAULT NULL,
  `cli_nomeconj` varchar(50) DEFAULT NULL,
  `cli_observacao` mediumtext,
  `cli_observacao_diario` mediumtext,
  PRIMARY KEY (`cli_codigo`),
  KEY `FK_clientes` (`cid_codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `clientes` (`cli_codigo`,`cli_razao`,`cli_fantasia`,`cli_cep`,`est_codigo`,`cid_codigo`,`cli_bairro`,`cli_logradouro`,`cli_enderecoreferencia`,`cli_numero`,`cli_fisicajuridica`,`cli_cpfcnpj`,`cli_rgie`,`cli_telfixo`,`cli_telfax`,`cli_telcelular`,`cli_contato`,`cli_email`,`cli_ativo`,`cli_datacadastro`,`cli_dataalterado`,`cli_nomepai`,`cli_nomemae`,`cli_naturalidade`,`cli_sexo`,`cli_estadocivil`,`cli_datanascimento`,`cli_nomeconj`,`cli_observacao`,`cli_observacao_diario`) VALUES 
 (1,'Wanderson Ferreira','Wanderson Ferreira','7800-130','51','5107602','Centro','Av. Rui Barbosa',NULL,'SN','fis','000.000.000-00',NULL,NULL,NULL,NULL,NULL,NULL,'sim','2021-04-17','2021-04-17',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `estado` (
  `est_codigo` char(2) COLLATE utf8_unicode_ci NOT NULL,
  `est_nome` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `estado` (`est_codigo`,`est_nome`,`est_sigla`) VALUES 
 ('11','RO','RO'),
 ('12','AC','AC'),
 ('13','AM','AM'),
 ('14','RR','RR'),
...
--
-- Definition of table `ocorrencia`
--

DROP TABLE IF EXISTS `ocorrencia`;
CREATE TABLE `ocorrencia` (
  `ocr_codigo` int(10) NOT NULL DEFAULT '0',
  `alu_matricula` bigint(20) NOT NULL,
  `ocr_datalancamento` date DEFAULT NULL,
  `ocr_horalancamento` char(5) DEFAULT '00:00',
  PRIMARY KEY (`ocr_codigo`),
  KEY `FK_ocorrencia` (`alu_matricula`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `ocorrencia` (`ocr_codigo`,`alu_matricula`,`ocr_datalancamento`,`ocr_horalancamento`) VALUES 
 (1,901347414,'2021-04-17','09:10');
/*!40000 ALTER TABLE `ocorrencia` ENABLE KEYS */;


--
-- Definition of table `ocorrencia_itens`
--

DROP TABLE IF EXISTS `ocorrencia_itens`;
CREATE TABLE `ocorrencia_itens` (
  `ocr_codigo` int(10) NOT NULL DEFAULT '0',
  `ocr_item_codigo` int(10) NOT NULL DEFAULT '0',
  `ocr_item_datalancamento` date DEFAULT NULL,
  `cliente_codigo` int(10) DEFAULT NULL,
  `tipo_codigo` int(10) DEFAULT NULL,
  `ocr_item_nroprocesso` varchar(30) DEFAULT NULL,
  `ocr_item_observacao` mediumtext,
  `ocr_item_cargahoraria` double DEFAULT NULL,
  `ocr_item_status` char(3) DEFAULT 'con' COMMENT 'and,con',
  `ocr_item_dataconclusao` date DEFAULT NULL,
  `ocr_item_horalancamento` char(5) DEFAULT '00:00',
  `ocr_item_horaconclusao` char(5) DEFAULT '00:00',
  PRIMARY KEY (`ocr_codigo`,`ocr_item_codigo`),
  KEY `FK_ocorrencia_itens` (`ocr_codigo`),
  KEY `FK_ocorrencia_itens_tipoprocesso` (`tipo_codigo`),
  KEY `FK_ocorrencia_itens_cliente` (`cliente_codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ocorrencia_itens`
--

/*!40000 ALTER TABLE `ocorrencia_itens` DISABLE KEYS */;
INSERT INTO `ocorrencia_itens` (`ocr_codigo`,`ocr_item_codigo`,`ocr_item_datalancamento`,`cliente_codigo`,`tipo_codigo`,`ocr_item_nroprocesso`,`ocr_item_observacao`,`ocr_item_cargahoraria`,`ocr_item_status`,`ocr_item_dataconclusao`,`ocr_item_horalancamento`,`ocr_item_horaconclusao`) VALUES 
 (1,1,'2021-04-17',1,3,'NS1213','Processo Envolvendo Família -  ETC',30,'and',NULL,'09:10','00:00');
/*!40000 ALTER TABLE `ocorrencia_itens` ENABLE KEYS */;
...
CREATE TABLE `tipo_processo` (
  `tp_codigo` int(10) NOT NULL,
  `tp_descricao` varchar(50) DEFAULT NULL,
  `tp_ativo` char(3) DEFAULT 'sim',
...
INSERT INTO `tipo_processo` (`tp_codigo`,`tp_descricao`,`tp_ativo`) VALUES 
 (1,'CIVIL','sim'),
 (2,'TRABALHISTA','sim'),
 (3,'FAMILIAR','sim');
