object FormAlunos: TFormAlunos
  ...
  object pg: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object Label12: TLabel
        ...
        FocusControl = dbe_localnascimento
      end
      ...
      object dbe_matricula: TDBEdit
        Left = 16
        Top = 24
        Width = 134
        Height = 21
        DataField = 'alu_matricula'
        DataSource = ds
        TabOrder = 0
      end
      ...
      object dbe_observacao: TDBMemo
        Left = 17
        Top = 184
        Width = 632
        Height = 54
        DataField = 'alu_observacao'
        DataSource = ds
        ScrollBars = ssVertical
        TabOrder = 9
      end
      object dbe_localnascimento: TDBEdit
        Left = 144
        Top = 261
        Width = 284
        Height = 21
        DataField = 'alu_localnascimento'
        DataSource = ds
        TabOrder = 11
      end
      ...
      object JvDBDateAlteracao: TJvDBDateEdit
        Left = 549
        Top = 261
        Width = 100
        Height = 21
        DataField = 'alu_dataalterado'
        DataSource = ds
        ReadOnly = True
        CheckOnExit = True
        ShowNullDate = False
  ...
  object QryHistorico: TSQLQuery
    ...
    SQL.Strings = (
      ...
      ' INNER JOIN clientes c ON(c.cli_codigo=oci.cliente_codigo)'
      ' INNER JOIN tipo_processo tp ON(tp.tp_codigo=oci.tipo_codigo)'
      'WHERE'
      '  oc.alu_matricula=:oc.alu_matricula'
      'ORDER BY'
    ...
    object QryHistoricocli_razao: TStringField
      FieldName = 'cli_razao'
      ProviderFlags = []
      Required = True
      Size = 100
  ...
  object cdsHistorico: TClientDataSet
    ...
    object cdsHistoricocli_razao: TStringField
    ...
    object cdsHistoricotp_descricao2: TStringField
