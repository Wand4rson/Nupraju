...
begin
  ...
  if Application.MessageBox('Deseja encerrar a Aplicação ?','Atenção',MB_YESNO+MB_ICONQUESTION) = mrNo then
    Abort;
...
begin
  StatusBar1.Panels[0].Text := 'Software Núcleo de Práticas Jurídicas';
