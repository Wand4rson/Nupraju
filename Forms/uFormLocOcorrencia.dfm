object FormLocOcorrencia: TFormLocOcorrencia
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Localizar Ocorr'#234'ncias'
  ClientHeight = 527
  ClientWidth = 815
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object JvComboCliente: TJvComboEdit
      Left = 7
      Top = 75
      Width = 138
      Height = 22
      ...
      ParentFont = False
      TabOrder = 3
      OnButtonClick = JvComboClienteButtonClick
      OnChange = JvComboClienteChange
      OnExit = JvComboClienteExit
    end
  end
  object PanelGridItem: TPanel
    ...
    object gridItem: TJvDBUltimGrid
      ...
      TitleFont.Style = []
      OnDrawColumnCell = gridItemDrawColumnCell
  ...
  object qry: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'FROM '
      'ocorrencia oc'
      'INNER JOIN alunos al ON(al.alu_matricula = oc.alu_matricula)'
      
        'INNER JOIN ocorrencia_itens oci ON(oc.ocr_codigo = oci.ocr_codig' +
        'o)'
      'GROUP BY oc.ocr_codigo ORDER BY oc.ocr_codigo DESC ')
    SQLConnection = DM.conn
    Left = 392
    Top = 184
    object qryocr_codigo: TIntegerField
      FieldName = 'ocr_codigo'
      ProviderFlags = []
      Required = True
    end
    ...
    object qryocr_datalancamento: TDateField
      FieldName = 'ocr_datalancamento'
      ProviderFlags = []
    end
    object qryocr_horalancamento: TStringField
      FieldName = 'ocr_horalancamento'
      ProviderFlags = []
      FixedChar = True
      Size = 5
    end
    object qryocr_item_nroprocesso: TStringField
      FieldName = 'ocr_item_nroprocesso'
      ProviderFlags = []
      Size = 30
    end
    object qrycliente_codigo: TIntegerField
      FieldName = 'cliente_codigo'
      ProviderFlags = []
    end
  end
  ...
  object cds: TClientDataSet
    ...
    Left = 464
    Top = 184
    object cdsocr_codigo: TIntegerField
      FieldName = 'ocr_codigo'
      ProviderFlags = []
      Required = True
    end
    ...
    object cdsocr_datalancamento: TDateField
      FieldName = 'ocr_datalancamento'
      ProviderFlags = []
    end
    object cdsocr_horalancamento: TStringField
      FieldName = 'ocr_horalancamento'
      ProviderFlags = []
      FixedChar = True
      Size = 5
    end
    object cdsocr_item_nroprocesso: TStringField
      FieldName = 'ocr_item_nroprocesso'
      ProviderFlags = []
      Size = 30
    end
    object cdscliente_codigo: TIntegerField
      FieldName = 'cliente_codigo'
      ProviderFlags = []
    end
  end
  ...
  object qryItem: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'INNER JOIN clientes cli ON(oci.cliente_codigo = cli.cli_codigo)'
        ...
        'INNER JOIN tipo_processo tipo ON(oci.tipo_codigo = tipo.tp_codig' +
        'o)'
      'WHERE'
      '  oci.ocr_codigo=:ocr_codigo'
      'ORDER BY oci.ocr_item_codigo ASC ')
    SQLConnection = DM.conn
    Left = 344
    Top = 376
  ...
  object cdsItem: TClientDataSet
    ...
    object cdsItemSituacao: TStringField
      FieldName = 'Situacao'
      ProviderFlags = []
      Size = 9
    end
